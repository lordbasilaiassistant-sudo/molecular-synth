...
| B | HRP | cube-st018 (C3) | edge (1, 5) | 3p | `GAGGATCTATGGCAGCCGTA` | `TACGGCTGCCATAGATCCTC` | 5.2 |
| C | catalase | cube-st027 (D4) | edge (5, 7) | 3p | `TGCGAGGTAACCTTTCGATC` | `GATCGAAAGGTTACCTCGCA` | 16.6 |
